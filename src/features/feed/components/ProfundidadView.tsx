        ...
        <div className="flex flex-col min-h-[100dvh] w-full bg-slate-50 relative isolate -mt-4 md:-mt-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center">
                            <span className="material-symbols-outlined text-brand-600 text-[18px]">psychology</span>
                        </div>
                        <div>
            ...
            {selectedTheme && selectedTheme !== 'mix' ? (
                <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 md:p-8 min-h-[600px] relative overflow-hidden">
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-3xl border border-brand/10 p-4 md:p-8 animate-fade-in relative z-10">
                        <ProfundidadSelector
                            options={(battles || [])
                                .filter((b) => {
