...
export function ResultsHeroFactual(_props: ResultsHeroFactualProps) {
  return (
    <section className="w-full bg-slate-50 pt-24 pb-12 md:pt-32 md:pb-16 border-b border-slate-200">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="p-8 md:p-10 lg:p-12">
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
                <div className="xl:col-span-7">
                  ...
                  <p className="mt-5 text-lg md:text-xl text-slate-600 leading-snug max-w-2xl">
                    Empate técnico entre apertura tecnológica y preocupación por
                    regulación, privacidad y control.
                  </p>

                  <div className="mt-8 flex flex-wrap items-center gap-3">
                    <div className="inline-flex items-center gap-2 rounded-full bg-rose-50 text-rose-700 px-4 py-2">
                      <Scale className="w-4 h-4" />
                      <span className="text-sm font-semibold">
                        Polarización máxima hoy
                      </span>
                    </div>

                    <div className="inline-flex items-center gap-2 rounded-full bg-slate-100 text-slate-700 px-4 py-2">
                      <span className="w-2 h-2 rounded-full bg-emerald-500" />
                      <span className="text-sm font-semibold">
                        14.500 señales · últimos 7 días
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="xl:col-span-5">
                  <div className="relative h-[240px] md:h-[280px] rounded-[1.75rem] overflow-hidden bg-[radial-gradient(circle_at_15%_60%,rgba(99,102,241,0.25),transparent_30%),radial-gradient(circle_at_70%_35%,rgba(16,185,129,0.22),transparent_28%),radial-gradient(circle_at_85%_75%,rgba(244,63,94,0.18),transparent_26%),linear-gradient(180deg,#eef2ff_0%,#ffffff_100%)]">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-[2rem] border border-rose-200 shadow-sm p-7 md:p-8">
              ...
              <p className="mt-3 text-sm md:text-base text-slate-500 leading-snug">
                Tus últimas señales en esta categoría te dejan fuera de la
                corriente dominante.
              </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          {[
            ["14.500", "señales analizadas"],
            ["52 / 48", "debate más dividido"],
            ["IA", "tema más activo"],
            ["Versus", "módulo con más participación"],
          ].map(([value, label]) => (
            <div
              key={label}
              className="bg-white border border-slate-200 rounded-2xl px-5 py-4 shadow-sm"
            >
              <div className="text-2xl md:text-3xl font-black tracking-tight text-slate-950">
                {value}
              </div>
