      ...
      <div className="w-full p-6 md:p-8 md:pl-[5.5rem] pl-20 relative flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 flex flex-col">
             <div className="mb-4">
                <h3 className="text-sm font-black text-slate-900">Ganador del Torneo</h3>
                <p className="text-[10px] uppercase tracking-widest font-bold text-slate-400 mt-0.5">La opción que superó todas las rondas</p>
             </div>
             
             {availability === "success" || availability === "degraded" ? (
                 <div className="relative bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/50 rounded-2xl p-6 flex flex-col items-center justify-center text-center h-full shadow-sm overflow-hidden group">
                   ...
                   <div className="relative z-10 flex flex-col items-center">
                     ...
                     <div className="text-[10px] font-bold text-amber-700 mt-2">Coronado por la mayoría</div>
                   </div>
                 </div>
             ) : (
          ...
          <div className="lg:col-span-6 flex flex-col">
             <div className="mb-4">
                <h3 className="text-sm font-black text-slate-900">Contexto Competitivo</h3>
                <p className="text-[10px] uppercase tracking-widest font-bold text-slate-400 mt-0.5">Detalles estadísticos del camino a la victoria</p>
             </div>
                    ...
                    <>
                      {metrics.mostDifficultPathEntity && (
                          <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex items-start gap-3">
                            <div className="p-1.5 bg-orange-100 text-orange-600 rounded shrink-0">
                              <Activity className="w-4 h-4" />
                            </div>
                            <div>
                              <div className="text-sm font-black text-slate-900 leading-tight">Rivales Difíciles</div>
                              <div className="text-[11px] font-medium text-slate-600 mt-1">El camino más difícil fue superado por <strong>{metrics.mostDifficultPathEntity}</strong>.</div>
                            </div>
                          </div>
                      )}
                      ...
                      {metrics.upsetRateLabel && (
                          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 flex items-start gap-3">
                            ...
                            <div>
                              <div className="text-sm font-black text-slate-900 leading-tight">Nivel de Sorpresas</div>
                              <div className="text-[11px] font-medium text-slate-600 mt-1">{metrics.upsetRateLabel}</div>
                            </div>
                          </div>
                      )}
