          ...
          <div className="lg:col-span-5 flex flex-col">
             <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-text-secondary mt-1">Lo que la mayoría de compradores prefiere</p>
                </div>
             </div>
                     ...
                     <div>
                       <div className="flex justify-between items-end mb-2">
                          <div className="flex items-center gap-2">
                             <span className="text-4xl font-black text-primary tracking-tighter leading-none">1</span>
                             <div className="flex flex-col">
                               <span className="font-black text-ink text-lg leading-none">{metrics.leaderEntityName}</span>
                               <span className="text-[10px] flex items-center gap-1 text-secondary uppercase tracking-widest font-bold mt-1">
                       ...
                       <div className="h-4 w-full bg-surface2 rounded-full overflow-hidden shadow-inner">
                          <div className="h-full bg-primary rounded-full shadow-[0_0_10px_rgba(37,99,235,0.3)]" style={{ width: metrics.preferenceShareLeader || '100%' }} />
                       </div>
                     </div>
                   )}
                   ...
                   {(metrics.mostContestedCategory || metrics.fragmentationLabel) && (
                     <div className="w-full bg-surface2 border border-stroke rounded-2xl p-5 mt-8 backdrop-blur-md">
                       <div className="flex gap-3 items-start">
                         <div className="w-2 h-2 rounded-full bg-secondary mt-1.5 shrink-0 shadow-[0_0_8px_rgba(16,185,129,0.4)]" />
          ...
          <div className="lg:col-span-7 flex flex-col">
             <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-text-secondary mt-1">Fragmentaciones y tensiones detectadas</p>
                </div>
             </div>
             ...
             <div className="flex flex-col gap-4">
                <div className="relative w-full bg-surface2 border border-stroke rounded-[2rem] p-6 md:p-8 overflow-hidden flex flex-col items-center justify-center text-center">
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-32 bg-primary/5 blur-[50px] pointer-events-none" />
