        ...
        <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1">
            ...
            <h1 className="text-3xl md:text-5xl font-black text-white leading-[1.1] tracking-tighter mb-4 max-w-3xl">
              Las marcas de Ahorro lideran la conversación y los Torneos mueven a tu generación
            </h1>
            
            <p className="text-base md:text-lg text-slate-300 font-medium mb-8 max-w-2xl leading-relaxed">
              Los Millennials inclinan las batallas en Consumo Diario y están impulsando el Torneo de Supermercados, que rompe récord de señales.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs font-bold">
              ...
              <div className="text-slate-400">
                Datos de las últimas 24 horas • 14 Nov • 18:42 h (GMT-6)
              </div>
            </div>
          </div>
          ...
          <div className="shrink-0 w-full md:w-auto">
            ...
            <div className="bg-slate-950/50 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col items-center justify-center min-w-[240px] shadow-2xl">
              ...
              <div className="flex items-center gap-1.5 px-3 py-1 bg-rose-500/20 text-rose-400 rounded-full border border-rose-500/30 text-xs font-black tracking-wide">
                <div className="bg-rose-500 rounded-full p-0.5"><TrendingUp className="w-3 h-3 text-white" /></div>
                +23.1% <span className="text-rose-400/70 font-bold ml-1">vs. semana anterior</span>
              </div>
            </div>
          </div>
