    ...
    <>
      <section className="card p-6 shadow-sm">
        <h3 className="text-sm font-black text-ink uppercase tracking-wider mb-5 flex items-center gap-2">
          <span className="material-symbols-outlined text-brand text-lg">analytics</span>
          Actividad
        </h3>
        <div className="space-y-4">
          <div className="flex justify-between items-center text-sm">
            <span className="text-slate-600 font-medium">Versus respondidos</span>
            <span className="font-mono font-black text-ink">{participation.versus_count}</span>
          </div>
          <div className="flex justify-between items-center text-sm">
            <span className="text-slate-600 font-medium">Preguntas perfil</span>
            <span className="font-mono font-black text-ink">{participation.progressive_count}</span>
          </div>
          <div className="flex justify-between items-center text-sm">
            <span className="text-slate-600 font-medium">Análisis profundo</span>
      ...
      <section className="card p-6 shadow-sm">
        <h3 className="text-sm font-black text-ink uppercase tracking-wider mb-5 flex items-center gap-2">
          <span className="material-symbols-outlined text-brand text-lg">history</span>
          Reciente
        </h3>
        <div className="space-y-4">
          {history.length === 0 ? (
            ...
            <div key={event.id} className="flex gap-4 items-start border-l-2 border-brand/30 pl-3 py-1">
