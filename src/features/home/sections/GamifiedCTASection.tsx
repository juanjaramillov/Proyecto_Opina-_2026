        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 w-full">
           ...
           <div className="w-full md:w-1/2 flex items-center justify-center relative pointer-events-none perspective-1000 mt-8 lg:mt-0">
             <div className="flex-col items-center justify-center relative pointer-events-none w-full h-[300px] lg:h-[480px] perspective-1000 scale-90 sm:scale-[1.1] transform-origin-center">
                 ...
                 <div className="absolute inset-0 flex items-center justify-center transform-style-3d">
                     ...
                     <div 
                         className="absolute w-[150%] h-[150%] bg-[linear-gradient(to_right,#2563EB_1.5px,transparent_1.5px),linear-gradient(to_bottom,#10B981_1.5px,transparent_1.5px)] bg-[size:50px_50px] opacity-[0.15] animate-[pulse_6s_ease-in-out_infinite]"
                         style={{ 
                     ...
                     <div className="absolute w-[80%] h-[80%] max-w-[400px] max-h-[400px] border-[2px] border-brand/20 rounded-full animate-[spin_15s_linear_infinite]" style={{ transform: 'rotateX(60deg) rotateY(15deg)' }}></div>
                     <div className="absolute w-[95%] h-[95%] max-w-[450px] max-h-[450px] border-[1.5px] border-accent/30 rounded-full animate-[spin_20s_linear_infinite_reverse]" style={{ transform: 'rotateX(50deg) rotateY(-20deg)' }}></div>
                     <div className="absolute w-[70%] h-[70%] max-w-[350px] max-h-[350px] border-[2px] border-accent/20 rounded-full animate-[spin_10s_linear_infinite]" style={{ transform: 'rotateX(70deg) rotateZ(30deg)' }}></div>
                 ...
                 <div className="relative z-20 w-32 h-32 md:w-40 md:h-40 flex items-center justify-center transition-transform duration-700 animate-[bounce_6s_ease-in-out_infinite] mx-auto mt-[20%] lg:mt-[15%]">
                     ...
                     <div className="absolute inset-[-50%] bg-[radial-gradient(circle_at_center,rgba(37,99,235,0.3),transparent_70%)] rounded-full blur-3xl animate-[pulse_3s_linear_infinite]"></div>
           ...
           <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-ink mb-6 tracking-tight leading-tight">
                Gana <GradientText className="hover:tracking-widest transition-all duration-300">influencia</GradientText>.
              </h2>
              <p className="text-xl text-slate-500 font-medium mb-10 max-w-lg">
                Compite, sube de nivel y desbloquea <span className="font-bold text-brand">recompensas exclusivas</span> mientras das tu opinión.
              </p>

              <GradientCTA
                label="Empieza a jugar"
                icon="arrow_forward"
