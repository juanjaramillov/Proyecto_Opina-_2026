...
const DepthQuestionCard: React.FC<DepthQuestionCardProps> = ({
    ...
    const renderInput = () => {
        ...
        if (type === 'scale_1_5' || type === 'scale' || type === 'nps_0_10') {
            // Regla:
            // - scale_1_5 = 1..5
            // - scale + id=recomendacion = 0..10 (legacy)
            // - nps_0_10 = 0..10 (nuevo)
            const max =
                type === 'nps_0_10'
                    ? 10
                ...
                <div className="grid grid-cols-1 gap-3">
                    {question.options?.map((opt) => (
                        ...
                        >
                            {opt}
                            <div
                                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors ${localValue === opt ? 'border-primary-600 bg-primary-600' : 'border-slate-200'
                                    }`}
                            >
            ...
            return (
                <div className="space-y-2">
                    ...
                    <div className="flex justify-end">
                        <span
                            className={`text-[10px] font-black tracking-widest ${String(localValue || '').length >= 140 ? 'text-rose-500' : 'text-slate-400'
                                }`}
                        >
        ...
        return (
            <div className="p-4 bg-rose-50 text-rose-600 rounded-xl text-xs font-bold">
    ...
    return (
        ...
        >
            ...
            <div className="min-h-[280px]">{renderInput()}</div>
