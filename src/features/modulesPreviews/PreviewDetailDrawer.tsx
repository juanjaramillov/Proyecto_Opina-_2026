    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-4">
                <span className="px-2 py-0.5 bg-brand/20 text-brand rounded-md text-[9px] font-black uppercase tracking-widest">{category}</span>
                <span className="flex items-center gap-1 text-[10px] font-black text-brand-600">
