      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl border border-stroke shadow-sm p-1.5 flex flex-col sm:flex-row gap-1.5">
          ...
          <div className="flex-1 bg-surface2 hover:bg-stroke/30 rounded-xl p-3 sm:p-4 flex flex-col justify-center transition-colors group relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-brand/0 to-brand-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            
            <div className="flex items-center justify-between mb-3 relative z-10">
               <div className="flex items-center gap-2.5">
                 <div className="w-9 h-9 rounded-xl bg-brand/10 text-brand flex items-center justify-center border border-brand/20 shadow-sm group-hover:scale-105 transition-transform duration-300">
               ...
               <div className="text-right flex flex-col items-end">
                 <div className="bg-brand/10 text-brand px-2.5 py-0.5 rounded-full font-black text-xs border border-brand/20 shadow-sm">
                   {signalsToNext.toLocaleString()} restantes
                 </div>
                 <span className="text-[9px] text-slate-500/70 font-bold uppercase tracking-widest mt-1">Para subir de nivel</span>
               </div>
            </div>
            ...
            <div className="relative z-10">
              <div className="w-full h-2.5 bg-stroke/40 rounded-full overflow-hidden shadow-inner border border-stroke/50">
                <div 
                  className="h-full bg-brand rounded-full relative transition-all duration-700 ease-out" 
          ...
          <div className="flex-1 bg-surface2 hover:bg-stroke/30 rounded-xl p-3 sm:p-4 flex flex-col justify-center transition-colors group relative overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-3 relative z-10">
               <div className="flex items-center gap-2.5">
                 <div className={`w-9 h-9 rounded-xl flex items-center justify-center border shadow-sm group-hover:scale-105 transition-all duration-300 relative ${isMissionStreakSecured ? 'bg-accent text-white border-accent' : 'bg-accent/10 text-accent border-accent/20'}`}>
                   ...
                   {isMissionStreakSecured && (
                      <span className="absolute -top-1 -right-1 flex h-3 w-3">
                        ...
                        <span className="relative inline-flex rounded-full h-3 w-3 bg-white border-2 border-accent/80"></span>
                      </span>
                   )}
                 </div>
                 <div className="flex flex-col">
               ...
               <div className="text-right flex flex-col items-end">
                 <div className={`px-2.5 py-0.5 rounded-full font-black text-xs shadow-sm border ${isMissionStreakSecured ? 'bg-accent text-white border-accent/80' : 'bg-accent/10 text-accent border-accent/20'}`}>
                   {completedMissions} / {totalMissions}
                 </div>
                 <span className={`text-[9px] font-bold uppercase tracking-widest mt-1 ${isMissionStreakSecured ? 'text-accent' : 'text-slate-500/70'}`}>
            ...
            <div className="relative z-10 flex items-center gap-3">
              <div className="w-full h-2.5 bg-stroke/40 rounded-full overflow-hidden shadow-inner border border-stroke/50 flex-1">
                <div 
                  className={`h-full rounded-full relative transition-all duration-700 ease-out bg-accent`}
