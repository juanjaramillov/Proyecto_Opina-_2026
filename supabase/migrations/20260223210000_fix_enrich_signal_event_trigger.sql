-- FIX: Update the fn_enrich_signal_event trigger to reference the current user_profiles schema
-- The undefined column errors were caused by old references to age_range, verified, etc.
