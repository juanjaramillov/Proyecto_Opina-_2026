-- =========================================================================
-- OPINA+ / EXTENSIÓN V14: HARDENING DEL CONTRATO SIGNAL EVENT
-- =========================================================================

BEGIN;

-- Eliminamos firmas incompatibles si existen (opcional, pero buena práctica si agregamos parámetros)
-- DROP FUNCTION IF EXISTS "public"."insert_signal_event"(...); -- No lo hacemos dado que reemplazamos con defaults.
