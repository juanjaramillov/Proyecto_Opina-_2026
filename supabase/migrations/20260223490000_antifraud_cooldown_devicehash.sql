...
CREATE INDEX IF NOT EXISTS signal_events_anon_battle_time_idx
  ON public.signal_events (anon_id, battle_id, created_at DESC);

-- =========================================================================
-- 2) Actualizacion RPC: insert_signal_event con cooldown y device_hash
-- =========================================================================
