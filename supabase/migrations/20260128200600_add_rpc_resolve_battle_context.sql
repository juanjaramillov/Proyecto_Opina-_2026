...
-- Entrada: slug de batalla (texto)
-- Salida: battle_id + metadata básica (sin battle_instance)
...
declare
  b record;
begin
  -- Nota: usamos battles.title como "slug" temporal si aún no tienes slug.
  -- Recomendado: agregar columna slug y cambiar esta búsqueda.
  select *
  into b
  from battles
