-- FIX: Remove strict INVITE_REQUIRED gate from insert_signal_event
-- This allows guests and users without invitation codes to cast basic votes, 
-- relying on the daily cap (v_daily_cap) for unverified users instead.
