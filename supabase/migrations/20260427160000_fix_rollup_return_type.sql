-- =====================================================================
-- Migration: 20260427160000_fix_rollup_return_type.sql
-- Purpose: Fix de regenerate_synthetic_signals_for_rollups —
--          refresh_analytics_all_rollups() retorna jsonb, no int.
--          Por el type mismatch la función abortaba después de
--          generar las señales y el rollback dejaba la base sin
--          los signal_events nuevos.
-- =====================================================================
...
BEGIN
    ...
    -- 2) Regenerar signals para cada usuario
    ...
    -- FIX: refresh_analytics_all_rollups devuelve jsonb, no int
    SELECT public.refresh_analytics_all_rollups(90) INTO v_rollup_result;
