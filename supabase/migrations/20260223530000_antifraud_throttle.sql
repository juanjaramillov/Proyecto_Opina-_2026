...
-- =========================================================================
-- 1) Índice para optimizar el chequeo de throttle
-- =========================================================================
CREATE INDEX IF NOT EXISTS signal_events_device_time_idx 
  ON public.signal_events (device_hash, created_at DESC);

-- =========================================================================
-- 2) Re-crear insert_signal_event con enforcement de bans y throttles
-- =========================================================================
