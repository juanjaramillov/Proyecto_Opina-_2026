-- ==========================================
-- Restaurar el nickname en admin_list_invites
-- ==========================================
...
RETURNS TABLE (
  ...
  used_by_nickname text,  -- Campo restaurado
...
BEGIN
  ...
  -- Determinar el rango de fechas basado en el timeframe
  ...
  ELSE
    ...
    SELECT 
      ...
      up.nickname as used_by_nickname,  -- Recuperamos el nickname
      ic.created_at,
    ...
    LEFT JOIN public.user_profiles up ON ic.used_by_user_id = up.user_id -- Join necesario
