...
export function getCuratedMasterHubSnapshot(userId: string, filters?: HubFilters): MasterHubSnapshot {
     ...
     insights: privacyState === 'optimal' ? [
         {
             ...
             relevanceMetric: 82, insightType: 'strength'
             // eslint-disable-next-line @typescript-eslint/no-explicit-any
         } as any
     ] : []
  };
      ...
      insights: privacyState === 'optimal' ? [
          {
              ...
              relevanceMetric: 65, insightType: 'divergent'
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
          } as any
      ] : []
  };
  ...
  const profundidadModule = {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      cognitiveBiases: ["Sesgo de Status Quo leve", "Aversión al riesgo moderada"] as any,
      consistencyScore: 88,
      insights: privacyState === 'optimal' ? [
          {
             segmentName: 'Comunidad',
             ...
             confidence: 'highly_confident',
             relevanceMetric: 88, insightType: 'strength'
             // eslint-disable-next-line @typescript-eslint/no-explicit-any
          } as any
      ] : []
  };
...
function getEmptySnapshot(): MasterHubSnapshot {
    return {
